...
<script type="text/javascript">
	function showDiv(toggle, tombol){
		document.getElementById(toggle).style.display = 'block';
		document.getElementById(tombol).style.display = 'none';
	}
	function showDiv2(toggle2, tombol1){
		document.getElementById(toggle2).style.display = 'block';
		document.getElementById(tombol1).style.display = 'none';
	}
	function showDiv3(toggle3, tombol2){
		document.getElementById(toggle3).style.display = 'block';
		document.getElementById(tombol2).style.display = 'none';
	}
	function showDiv4(toggle4, tombol3){
		document.getElementById(toggle4).style.display = 'block';
		document.getElementById(tombol3).style.display = 'none';
	}
	function showDiv5(toggle5, tombol4){
		document.getElementById(toggle5).style.display = 'block';
		document.getElementById(tombol4).style.display = 'none';
	}
	function showDiv6(toggle6, tombol5){
		document.getElementById(toggle6).style.display = 'block';
		document.getElementById(tombol5).style.display = 'none';
	}
	function showDiv7(toggle7, tombol6){
		document.getElementById(toggle7).style.display = 'block';
		document.getElementById(tombol6).style.display = 'none';
	}
</script>
...
<div class="container clearfix">	
	...
	<div id="header-right" style="margin-top:10px">
		<a href="cetak-topsis.php" target="_BLANK" class="button">Cetak PDF</a>
		<a href="cetak-topsis2.php" target="_BLANK" class="button">Cetak CSV</a>
	</div>
	...
	<div class="main-content main-content-full the-content">
		...
		<table class="pure-table pure-table-striped">
			...
			<tbody>
				<?php while($hasill = $query6->fetch()): ?>
					<tr>
						<td colspan="5" style="background-color:pink"><?php echo $hasill['nama']; ?></td>
								<?php 
		...
		<center>
			<button class="button" onclick="showDiv('toggle','tombol')" id="tombol" style="display:block">Proses Data</button>
		</center>
	</div>

	<div class="main-content main-content-full the-content" id="toggle" style="display:none">
		...
		<center>
			<button class="button" onclick="showDiv2('toggle2', 'tombol1')" id="tombol1" style="display:block">Proses Data</button>
		</center>
	</div>

	<div class="main-content main-content-full the-content" id="toggle2" style="display:none">
		...
		<center>
			<button class="button" onclick="showDiv3('toggle3', 'tombol2')" id="tombol2" style="display:block">Proses Data</button>
		</center>
	</div>
	
	<div class="main-content main-content-full the-content" id="toggle3" style="display:none">
		<!-- Step 3: Matriks Y ==================== -->
		...
		<center>
			<button class="button" onclick="showDiv4('toggle4', 'tombol3')" id="tombol3" style="display:block">Proses Data</button>
		</center>
	</div>
	
	<div class="main-content main-content-full the-content" id="toggle4" style="display:none">
		...
		<center>
			<button class="button" onclick="showDiv5('toggle5', 'tombol4')" id="tombol4" style="display:block">Proses Data</button>
		</center>
	</div>
	
	<div class="main-content main-content-full the-content" id="toggle5" style="display:none">		
		...
		<center>
			<button class="button" onclick="showDiv6('toggle6', 'tombol5')" id="tombol5" style="display:block">Proses Data</button>
		</center>
	</div>
	
	<div class="main-content main-content-full the-content" id="toggle6" style="display:none">
		...
		<center>
			<button class="button" onclick="showDiv7('toggle7', 'tombol6')" id="tombol6" style="display:block">Proses Data</button>
		</center>
	</div>
	
	<div class="main-content main-content-full the-content" id="toggle7" style="display:none">
		<!-- Step 7: Perangkingan ==================== -->
		<?php		
		$sorted_ranks = $ranks;	
